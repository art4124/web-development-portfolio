...
const translations={
  en:{
    ...
    metaProjects:"Live website",metaLanguages:"Languages supported",metaResponsive:"Responsive design",floatResponsive:"Responsive ✓",floatDeployed:"Deployed ✓",
  ...
  es:{
    ...
    metaProjects:"Sitio en vivo",metaLanguages:"Idiomas disponibles",metaResponsive:"Diseño responsivo",floatResponsive:"Responsivo ✓",floatDeployed:"Publicado ✓",
  ...
  ko:{
    ...
    metaProjects:"라이브 웹사이트",metaLanguages:"지원 언어",metaResponsive:"반응형 디자인",floatResponsive:"반응형 ✓",floatDeployed:"배포 완료 ✓",
    ...
    designedKicker:"DESIGNED BY",designedTitle:"제가 방향을 이끈 협업형 빌드입니다.",designedText:"이 웹사이트는 저의 프로젝트 방향과 의사결정에 AI 지원 개발과 GitHub 기반 버전 관리를 결합해 만들었습니다.",designedAlanna:"프로젝트 방향 · UX/UI · QA",designedChatgpt:"AI 개발 협업",designedClaude:"AI 개발 협업",designedGithub:"버전 관리 · 배포",
